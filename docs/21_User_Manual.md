...
1. פתח את `/upload`.
2. בחר עד 20 תמונות JPEG, PNG או WebP של טבלאות הזמנה, או קובץ PDF אחד של עד
   20 עמודים. שמות הקבצים אינם
   מוצגים או נשמרים בתוצאה.
   אפשר גם לבחור **צלם תמונת מסמך** עבור עמוד בודד. בדפדפן תומך עשויה להיפתח
   המצלמה האחורית; בדפדפנים אחרים עשוי להיפתח בורר קבצים. צילום או PDF כזה מחליף
