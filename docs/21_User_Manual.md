...
3. אחרי צילום, פתח את התצוגה המקדימה המקומית ובדוק שהטבלה חדה וקריאה. הצילום
   ...
   המקדימה ובדיקת הממדים, או להחליף רק את אותו עמוד לפני OCR.
   ...
   חדות או צל, אינה שולחת או שומרת את התמונה באופן מתמשך, ואינה מחליפה את
   בדיקת השרת. אם אותו עמוד דורש צילום חדש, בחר במפורש צילום חלופי באותו עמוד;
   הוא מחליף רק את העמוד המקומי ואינו נשלח עד להפעלת OCR. צילום של אצווה חדשה
   במקום כל האצווה הקיימת תמיד ממתין לאישור מפורש.
