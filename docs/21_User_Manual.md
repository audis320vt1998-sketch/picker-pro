...
6. העבר את הקובץ המלא לעדכון מבוקר של `catalogs/products.json`.

ההורדה אינה מעלה קובץ, אינה מייבאת נתונים, ואינה משנה או מאמתת את הקטלוג
הפעיל.

## מה אינו זמין

- PDF, HEIC, תיקון פרספקטיבה או שינוי סדר עמודים.
