...
אפשר לאשר, לתקן או למחוק את המספר מול הדף המקורי. זהו מידע לעמוד בלבד: הוא
אינו בוחר עיר, אינו מקבץ הזמנות ואינו יוצר ליקוט או סיכום.
...
אטום, מיקום שורה, מזהי מוצר ושלוש כמויות מקור להשוואה בלבד. אם אושר קו
חלוקה, היא מעבירה רק את הקוד המספרי הקצר שלו כתצוגה ליד שורת העמוד; הקוד אינו
נשלח לשירות הבדיקה ואינו משנה את הסיכום. ההעברה אינה מעבירה תמונה, שם קובץ,
