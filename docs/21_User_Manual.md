...
אינו בוחר עיר, אינו יוצר קבוצת הפצה ואינו יוצר יצוא או ליקוט שמור. `01` ו־`1`
...
הכולל, אינו ממפה עיר ואינו יוצר יצוא. ההעברה אינה מעבירה תמונה, שם קובץ,
...
- התוצאה השמורה היא תצוגה בלבד: היא אינה ממשיכה טיוטת OCR, אינה שולחת שוב
  שורות ל־API, אינה בוחרת עיר, אינה מפיקה יצוא ואינה יוצרת רשימת ליקוט.
