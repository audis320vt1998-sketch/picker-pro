...
3. אחרי צילום, פתח את התצוגה המקדימה המקומית ובדוק שהטבלה חדה וקריאה. הצילום
   ...
   המקדימה ובדיקות הממדים והתאורה, או להחליף רק את אותו עמוד לפני OCR.
   במסך זה מוצגת בדיקה מקומית של סוג התמונה וממדיה. בעמוד שנפתח לבדיקה, הדפדפן
   יכול גם להתריע על חושך קיצוני או על צל/אור לא אחיד בתמונה. הודעה ירוקה אומרת
   שהממדים עומדים בסף הבסיסי; אזהרה צהובה ממליצה לצלם שוב. בדיקת התאורה אינה
   קוראת טקסט, אינה בוחנת חדות או מאשרת OCR, אינה שולחת או שומרת את התמונה
   באופן מתמשך, ואינה מחליפה את בדיקת השרת. אם אותו עמוד דורש צילום חדש, בחר
   במפורש צילום חלופי באותו עמוד; הוא מחליף רק את העמוד המקומי ואינו נשלח עד
   להפעלת OCR. צילום של אצווה חדשה במקום כל האצווה הקיימת תמיד ממתין לאישור
   מפורש.
...
- בחירת תמונה חלופית מסירה את הטיוטה הקודמת ואת השורות שנבחרו מאותו עמוד,
  ...
  לצד התמונה החלופית מוצגות אותן בדיקות סוג, ממדים ותאורה מקומיות (כאשר
